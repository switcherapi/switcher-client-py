...
class ExecutionLogger:
    ...
    def add(response: ResultDetail, key: str, input: Optional[List[List[str]]] = None) -> None:
        ...
        for index, log in enumerate(_logger):
    ...
    @classmethod
    def callback_error(cls) -> Optional[Callable[[Exception], None]]:
        """Returns the subscribed error callback."""
        return cls._callback_error
